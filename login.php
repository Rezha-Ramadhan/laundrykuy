...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="assets/images/icon.jpeg" type="image/jpeg"/>
    ...
    <style>
        .accountbg {
            background:url('assets/images/background.jpeg')no-repeat center fixed;
            ...
            <div class="avatar">
                <div class="card-body">
                    <h3 class="text-center mt-0 m-b-15">
                        <a href="login.php"><img src="assets/images/logo3.jpeg" width="180px"></a>
                    </h3>

                    <div class="p-3">
                        <h4 class="text-center mt-0 m-b-15">Login LaundryKuy</h4>
